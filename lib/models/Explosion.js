define(['Game', 'SpriteModel', 'fx/BulletHit', 'Vector', 'fx/Audio', 'sprites/ExplosionSprite'],
       function (Game, SpriteModel, BulletHit, Vector, Audio, ExplosionSprite) {
  ...
  Explosion.createNew = function (position, originObject) {
    ...
    var sprite = new ExplosionSprite(explosion);

    Game.addSprite(explosion, sprite);
  };
