define(['Game', 'SpriteModel', 'sprites/SmokeSprite'], function (Game, SpriteModel, SmokeSprite) {
  ...
  Smoke.createNew = function (position) {
    var smoke       = new Smoke();
    var smokeSprite = new SmokeSprite(smoke);
    smoke.pos.set(position);
    Game.addSprite(smoke, smokeSprite);
  };
