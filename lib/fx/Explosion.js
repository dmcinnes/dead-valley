define(['Game', 'Sprite', 'fx/BulletHit', 'Vector', 'Sky'], function (Game, Sprite, BulletHit, Vector, Sky) {
  ...
  // preload the image so it doesn't stall on first load
  Game.assetManager.loadImage('explosion');
