define(['Game', 'Sprite', 'Vector'], function (Game, Sprite, Vector) {
  ...
  var Hint = function (config) {
    ...
    if (this.config.windowPos) {
      ...
      // TODO this should take into accout rotations
      var sprite = this.config.sprite;
      xoffset = Math.round(sprite.tileHeight / 2);
      yoffset = Math.round(sprite.tileHeight / 2);
      this.pos = sprite.pos.add(new Vector(xoffset, yoffset));
    } else {
