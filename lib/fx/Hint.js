define(['Game', 'Sprite', 'Vector'], function (Game, Sprite, Vector) {
  ...
  var defaults = {
    ...
    duration:      6,      // how long is lasts (including fade time)
  ...
  var Hint = function (config) {
    ...
    if (this.config.static) {
      ...
      this.render(0.01);
      // override render with our static one
      this.render = this.staticRender;
    }
  ...
  Hint.prototype.staticRender = function (delta) {
    // update opacity
    this.draw(delta);
