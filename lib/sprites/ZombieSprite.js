define(["Vector",
  ...
  ZombieSprite.prototype.draw = function (delta) {
    ...
    this.center.x = (model.direction == RIGHT) ? this.originalCenterX : this.originalCenterX + 4;
  ...
  ZombieSprite.prototype.render = function (delta) {
    ...
    if (model.takingDamage && this.imageData) {
      context.save();
      context.translate(model.pos.x - map.originOffsetX - this.center.x,
                        model.pos.y - map.originOffsetY - this.center.y);
