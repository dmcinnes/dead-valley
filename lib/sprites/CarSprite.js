  ...
  CarSprite.prototype.draw = function () {
    ...
    if (car.headlightsOn) {
      if (car.headlights.left) {
        this.drawTile(3);
        Headlight.render(this, car.headlightsPos.left);
      }
      if (car.headlights.right) {
        this.drawTile(4);
        Headlight.render(this, car.headlightsPos.right);
      }
      if (car.taillights.left) {
        Taillight.render(this, 5, car.braking);
      }
      if (car.taillights.right) {
        Taillight.render(this, 6, car.braking);
      }
    }
