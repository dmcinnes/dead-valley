...
define(["Game", "Sprite", "Sky"],
  ...
  DudeSprite.prototype.render = function (delta) {
    ...
    if (this.lightImage && Sky.isDark()) {
      ...
      context.translate(dude.pos.x - map.originOffsetX - this.lightImage.width/2,
                        dude.pos.y - map.originOffsetY - this.lightImage.height/2);
  ...
  DudeSprite.prototype.drawAimedArm = function (frame) {
    ...
    var left = -(frame * dude.tileWidth) - this.imageOffset.x;
