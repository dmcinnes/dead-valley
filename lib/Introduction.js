define(['Game', 'GameTime', 'Vector', 'hud/Hud', 'fx/Hint'], function (Game, GameTime, Vector, Hud, Hint) {
  ...
  var Hints = {
    move: {
      windowPos: new Vector(centerX, 115, true),
      duration:  6,
      text:      "Use <b>&larr;&uarr;&darr;&rarr;</b> or<br>WASD to move around.",
      tail:      false
    },
    skip: {
      windowPos:    new Vector(64, 550, true),
      text:         "Disable Hints",
      tail:         false,
      id:           'skip-hints',
      fadeDuration: 0.5,
    ...
    buildingInventory: {
      windowPos: new Vector(136, 185, true),
      duration:  6,
      text:      "This is the Building's Inventory.",
      tail:      'bottom'
    },
    showInventory: {
      windowPos: new Vector(716, 105, true),
      duration:  6,
      text:      "Press I to show your Inventory.",
      tail:      false
    },
    closeInventory: {
      windowPos: new Vector(756, 295, true),
      duration:  6,
      text:      "Press I again to close your Inventory.",
      tail:      false
    },
    dragPistol: {
      windowPos: new Vector(786, 165, true),
      duration:  6,
    ...
    leaveHouse: {
      windowPos: new Vector(166, 115, true),
      duration:  6,
    ...
    showCarInventory: {
      windowPos: new Vector(700, 115, true),
      duration:  6,
      text:      "Bring up the truck's inventory by pressing I.",
      tail:      false
    },
    truckInventory: {
      windowPos: new Vector(280, 182, true),
      duration:  6,
      text:      "This is the Truck's Inventory.",
      tail:      'bottom'
    },
    fuelGauge: {
      windowPos: new Vector(123, 93, true),
      duration:  6,
