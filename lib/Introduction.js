define(['Game', 'Vector', 'hud/Hud', 'fx/Hint'], function (Game, Vector, Hud, Hint) {
  ...
  var Hints = {
    move: {
      windowPos: new Vector(416, 115, true),
      text:      "Use the Arrow keys or<br>WASD to move around.",
      tail:      false
    },
    skip: {
      windowPos:    new Vector(60, 550, true),
      text:         "Disable Hints",
      tail:         false,
      id:           'skip-hints',
      fadeDuration: 0.5,
    ...
    buildingInventory: {
      windowPos: new Vector(106, 185, true),
    ...
    closeInventory: {
      windowPos: new Vector(716, 245, true),
      text:      "Press I again to close your Inventory.",
      tail:      false
    },
    dragPistol: {
      windowPos: new Vector(776, 165, true),
    ...
    leaveHouse: {
      windowPos: new Vector(116, 115, true),
    ...
    showCarInventory: {
      windowPos: new Vector(646, 115, true),
      text:      "Bring up the car's inventory by pressing I.",
      tail:      false
    },
    truckInventory: {
      windowPos: new Vector(101, 230, true),
      text:      "This is the Truck's Inventory.",
      tail:      'bottom'
    },
    fuelGauge: {
      windowPos: new Vector(91, 95, true),
