  ...
  var Map = function (gridWidth, gridHeight) {
    ...
    this.loadStartMapTiles = function (nw, sw, ne, se) {
      ...
      Progress.run(function (callback) {
                     self.loadMapTiles(chunks.nw, 'nw', {name:nw}, callback);
                   }, function (callback) {
                     self.loadMapTiles(chunks.sw, 'sw', {name:sw}, callback);
                   }, function (callback) {
                     self.loadMapTiles(chunks.ne, 'ne', {name:ne}, callback);
                   }, function (callback) {
                     self.loadMapTiles(chunks.se, 'se', {name:se}, callback);
                   }, function () {
                     self.loaded();
                   });
